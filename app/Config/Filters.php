...
class Filters extends BaseConfig
{
    ...
    public $filters = [
        'login' => [
            'before' => [
                'admin/*', // Todos os controles que estão dentro do namespace 'Admin só serão acessados com login.
            ]
         ],
         'admin' => [
            'before' => [
                'admin/*', // Todos os controles que estão dentro do namespace 'Admin só serão acessados por um Adm.
            ]
         ],
    ];
}
