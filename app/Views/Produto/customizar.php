    ...
    <div class="product-content product-wrap clearfix product-deatil">
        <div class="row">   
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                            ...
                            <div id="imagemPrimeiroProduto" style="margin-bottom: 1em;">
                                <img class="img-responsive center-block d-block" src="<?php echo site_url("web/src/assets/img/question.jpg"); ?>" width="200" alt="Escolha o produto">
                            </div>

                    <label>Escolha a primeira metade</label>
            ...
            <label>Tamanho do produto</label>
                <select id="tamanho" class="form-control" name="tamanho"></select>
            </div> 

            <div class="col-md-6">
                <div id="boxInfoExtra" style="display: none;">
                    <label>Extras</label>
                    <div class="radio">
                        <label>
                    ...
                    <div id="extras">
                            <!-- renderização dos extras via java -->
                    </div>
  ...
  <script>
    ...
    $(document) .ready(function () {
        ...
        $("#primeira_metade").on('change', function(){
            ...
            $("#imagemPrimeiroProduto").html('<img class="img-responsive center-block d-block" src="<?php echo site_url("web/src/assets/img/question.jpg"); ?>" width="200" alt="Escolha o produto">');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.imagemPrimeiroProduto){
                        ...
                        $("#imagemPrimeiroProduto").html('<img class="img-responsive center-block d-block" src="<?php echo site_url("produto/imagem/"); ?>' + data.imagemPrimeiroProduto + '" width="200" alt="Escolha o produto">');
            ...
            $("#segunda_metade").on('change', function(){
                ...
                $("#imagemSegundoProduto").html('<img class="img-responsive center-block d-block" src="<?php echo site_url("web/src/assets/img/question.jpg"); ?>" width="200" alt="Escolha o produto">');
                ...
                if(primeiro_produto_id && segundo_produto_id){
                    ...
                    success: function (data) {
                        ...
                        if(data.imagemSegundoProduto){
                            ...
                            $("#imagemSegundoProduto").html('<img class="img-responsive center-block d-block" src="<?php echo site_url("produto/imagem/"); ?>' + data.imagemSegundoProduto + '" width="200" alt="Escolha o produto">');
        ...
        $("#tamanho").on('change', function() {
            ...
            $("#btn-adiciona").prop("disable", true);
