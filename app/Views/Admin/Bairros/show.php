            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-header bg-primary pb-0 pt-4">
                  <h4 class="card-title text-white"><?php echo esc($titulo); ?> | Sertãozinho-SP</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                      <spam class="font-weight-bold">Valor de entrega:</spam>
                    ...
                    <?php else: ?>
                      ...
                      <a href="<?php echo site_url("admin/bairros/desfazerexclusao/$bairro->id"); ?>" class="btn btn-dark btn-sm mr-2">
