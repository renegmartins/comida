            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="ui-widget">
                    <input id="query" name="query" placeholder="Pesquise por um bairro de Sertãozinho" class="form-control bg-light mb-5">
                  </div>
                        ...
                        term: request.term
                            ...
                            success: function (data) {
                                ...
                                if(data.length < 1) {
                                    ...
                                    var data = [
                                        {
                                            label: 'Bairro de Sertãozinho não encontrado',
                                            value: -1
                                        }
                                    ];
