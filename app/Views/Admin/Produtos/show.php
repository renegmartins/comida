              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php endif; ?>
                    ...
                    <p class="card-text">
                      <spam class="font-weight-bold">Categoria:</spam>
                      <?php echo esc($produto->categoria);?>
                    </p>
                    <p class="card-text">
                      <spam class="font-weight-bold">Slug:</spam>
                    ...
                    <?php else: ?>
                      ...
                      <a href="<?php echo site_url("admin/produtos/desfazerexclusao/$produto->id"); ?>" class="btn btn-dark btn-sm mr-2">
