...
<style>
  ...
  .select-container--default .select2-selection--single .select-selection__rendered{
    line-height: 18px;
  }

  .select2-container--dafult .select2-selection--single .select2-selection__arrow b{
    top: 80%;
  }
</style>
              ...
              <div class="card">
                ...
                <?php echo form_open("admin/produtos/cadastrarespecificacoes/$produto->id"); ?>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <label>Escolha a medida do produto<a href="javascrip:void" class="" data-toggle="popover" title="Medida do produto" data-content="Exemplo de uso para pizza: <br>Pizza Grande <br>Pizza Média <br>Pizza Pequena"> Entenda</a></label>
                      ...
                      <div class="form-group col-md-4">
                            ...
                            <label>Produto customizável<a href="javascrip:void" class="" data-toggle="popover" title="Produto meio a meio" data-content="Exemplo de uso para pizza: <br>Metade calabresa e metade frango com catupiry"> Entenda</a></label>
              ...
              <div class="form_row">
                <div class="col-md-12">
                  ...
                  <div class="alert alert-warning" role="alert">
                    ...
                    <p>Esse produto não possui especificação no momento. Portanto <strong>não será exibido</strong> como opção de compra na área pública</p>
                      <hr>
                    <p class="mb-0">Aproveite agora para cadastrar uma especificação para o <strong><?php echo esc($produto->nome); ?></strong>.</p>
                  </div>
