                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                      ...
                      <?php else : ?>
                        ...
                        <img class="card-img-top w-75" src="<?php echo site_url('admin/images/usuario-sem-imagem.png') ?>" alt="entregador sem imagem">
                  ...
                  <?php endif; ?>
                    ...
                    <p class="card-text">
                      <spam class="font-weight-bold">Telefone:</spam>
                      <?php echo esc($entregador->telefone);?>
                    </p>
                    <p class="card-text">
                      <spam class="font-weight-bold">Veículo:</spam>
                    ...
                    <?php else: ?>
                      ...
                      <p class="card-text">
                      <spam class="font-weight-bold text-danger">Excluído:</spam>
                    ...
                    <?php else: ?>
                      ...
                      <a href="<?php echo site_url("admin/entregadores/desfazerexclusao/$entregador->id"); ?>" class="btn btn-dark btn-sm mr-2">
