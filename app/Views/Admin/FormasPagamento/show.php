                ...
                <div class="card-body">
                  <?php if ($forma->id == 2): ?>
                    <div class="alert alert-primary" role="alert">
                          ...
                          não pode ser <span class="text-danger">editada ou excluída</span>, pois essa opção terá
                          vinculada ou não o envio de troco para o cliente quando o mesmo estiver no <strong>Checkout</strong>.
                  ...
                  <?php endif ; ?>
                    ...
                    <?php else: ?>
                      ...
                      <a href="<?php echo site_url("admin/formas/desfazerexclusao/$forma->id"); ?>" class="btn btn-dark btn-sm mr-2">
