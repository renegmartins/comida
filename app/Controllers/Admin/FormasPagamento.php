...
class FormasPagamento extends BaseController{
    ...
    public function excluir($id = null){
        ...
        if($formaPagamento->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A forma de pagamento $formaPagamento->nome já se encontra como excluída.") ;
        ...
        if($this->request->getMethod() === 'post'){
            ...
            return redirect()->to(site_url('admin/formas'))->with('sucesso', "Forma de pagamento $formaPagamento->nome excluído com sucesso");
