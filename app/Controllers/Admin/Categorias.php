...
class Categorias extends BaseController{
    ...
    public function editar($id = null){
        ...
        if($categoria->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A categoria $categoria->nome já se encontra como excluído. Portanto não é possível editá-la.") ;
    ...
    public function atualizar($id = null){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($categoria->deletado_em != null){
                ...
                return redirect()->back()->with('info', "A categoria $categoria->nome já se encontra como excluída. Portanto não é possível atualizá-lo.") ;
    ...
    public function excluir($id = null){
        ...
        if($categoria->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A categoria $categoria->nome já se encontra como excluída.") ;
