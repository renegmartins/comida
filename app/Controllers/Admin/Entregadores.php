...
class Entregadores extends BaseController{
    ...
    public function criar(){
        ...
        $data = [
            'titulo' => "Cadastrando novo entregador",
    ...
    public function editar($id = null){
        ...
        if($entregador->deletado_em != null){
            ...
            return redirect()->back()->with('info', "O entregador $entregador->nome já se encontra como excluído. Portanto não é possível editá-lo.") ;
    ...
    public function atualizar($id = null){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($entregador->deletado_em != null){
                ...
                return redirect()->back()->with('info', "O entregador $entregador->nome já se encontra como excluída. Portanto não é possível atualizá-la.") ;
            ...
            if($this->entregadorModel->save($entregador)){
                ...
                return redirect()->to(site_url("admin/entregadores/show/$entregador->id"))
                                ->with('sucesso', "Entregador $entregador->nome atualizada com sucesso");
    ...
    public function upload($id = null){
        ...
        $tamanhoImagem = $imagem->getSizeByUnit('b');

        if($tamanhoImagem < 2000){

            return redirect()->back()->with('atencao', 'O arquivo selecionado excede o tamanho permitido. 2MB');
...
//------------------------------- A partir deste ponto fazemos o store da imagem -------------------------------//
