...
class Usuarios extends BaseController
{
    ...
    public function editar($id = null){
        ...
        if($usuario->deletado_em != null){
            ...
            return redirect()->back()->with('info', "O usuário $usuario->nome já se encontra como excluído. Portanto não é possível editá-lo.") ;
    ...
    public function atualizar($id = null){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($usuario->deletado_em != null){
                ...
                return redirect()->back()->with('info', "O usuário $usuario->nome já se encontra como excluído. Portanto não é possível atualizá-lo.") ;
    ...
    public function excluir($id = null){
        ...
        if($usuario->deletado_em != null){
            ...
            return redirect()->back()->with('info', "O usuário $usuario->nome já se encontra como excluído.") ;
