...
class Medidas extends BaseController{
    ...
    public function cadastrar(){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($this->medidaModel->save($medida)){
                ...
                return redirect()->to(site_url("admin/medidas/show/$medida->id" . $this->medidaModel->getInsertID()))
    ...
    public function editar($id = null){
        ...
        if($medida->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A medida $medida->nome já se encontra como excluído. Portanto não é possível editá-lo.") ;
    ...
    public function atualizar($id = null){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($medida->deletado_em != null){
                ...
                return redirect()->back()->with('info', "A medida $medida->nome já se encontra como excluída. Portanto não é possível atualizá-la.") ;
    ...
    public function excluir($id = null){
        ...
        if($medida->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A medida $medida->nome já se encontra como excluída.") ;
