...
class Extras extends BaseController{
    ...
    public function criar(){
        ...
        $data = [
            'titulo' => "Criando novo extra $extra->nome",
            'extra' => $extra,
        ];
    ...
    public function cadastrar(){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($this->extraModel->save($extra)){
                ...
                return redirect()->to(site_url("admin/extras/show/$extra->id" . $this->extraModel->getInsertID()))
    ...
    public function editar($id = null){
        ...
        if($extra->deletado_em != null){
            ...
            return redirect()->back()->with('info', "O extra $extra->nome já se encontra como excluído. Portanto não é possível editá-lo.") ;
    ...
    public function atualizar($id = null){
        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($extra->deletado_em != null){
                ...
                return redirect()->back()->with('info', "O extra $extra->nome já se encontra como excluído. Portanto não é possível atualizá-lo.") ;
    ...
    public function excluir($id = null){
        ...
        if($extra->deletado_em != null){
            ...
            return redirect()->back()->with('info', "A extra $extra->nome já se encontra como excluída.") ;
